package com.touchme.persistance.source.sqlite;

import android.database.Cursor;

import com.touchme.persistance.framework.filter.*;
import com.touchme.persistance.framework.mapping.Mapping;
import com.touchme.persistance.framework.query.Query;
import com.touchme.persistance.framework.sort.FieldOrder;
import com.touchme.persistance.framework.sort.Order;
import com.touchme.persistance.framework.sort.OrderSet;
import com.touchme.persistance.framework.sort.RandomOrder;
import com.touchme.persistance.source.relational.FieldPersistable;
import com.touchme.persistance.source.sql.query.*;
import com.touchme.persistance.source.sql.query.Operator;
...
public class QuerySqlite<PROJECTION, TARGET, RESULT> extends Query<Select, WhereClause, OrderClause, RESULT, Cursor, TARGET, PROJECTION>
{
	...
	public WhereClause visit(NotFilter<? super PROJECTION> notFilter)
	{
		Filter<? super PROJECTION> inversedFilter = notFilter.getFilter().accept(new FilterVisitorGenerified<PROJECTION, RESULT,Object,Filter<? super PROJECTION>>()
		{
			...
			{
				final com.touchme.persistance.framework.filter.Operator inversedOp;
				switch (fieldFilter.getOperator())
				{
					case NEQ:
						inversedOp = com.touchme.persistance.framework.filter.Operator.EQ;
						break;
					case EQ:
						inversedOp = com.touchme.persistance.framework.filter.Operator.NEQ;
						break;
					case GE:
						inversedOp = com.touchme.persistance.framework.filter.Operator.LT;
						break;
					case GT:
						inversedOp = com.touchme.persistance.framework.filter.Operator.LE;
						break;
					case LE:
						inversedOp = com.touchme.persistance.framework.filter.Operator.GT;
						break;
					case LIKE:
						inversedOp = com.touchme.persistance.framework.filter.Operator.NOT_LIKE;
						break;
					case NOT_LIKE:
						inversedOp = com.touchme.persistance.framework.filter.Operator.LIKE;
						break;
					case LT:
						inversedOp = com.touchme.persistance.framework.filter.Operator.GE;
						break;
					default:
